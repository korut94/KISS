...
public:
    ...
    const KC_SpatialGrid& GetSpatialGrid(size_t anIndex) const { return mySpatialGrids[anIndex]; }
    KC_SpatialGrid& GetSpatialGrid(size_t anIndex) { return mySpatialGrids[anIndex]; }
