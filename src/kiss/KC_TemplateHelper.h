...
struct GetTupleTypeIndex<T, std::tuple<Types...>, Index> : std::conditional<
    ...
    std::integral_constant<std::size_t, Index>, GetTupleTypeIndex<T, std::tuple<Types...>, Index + 1>
>::type {};

template <typename T, std::size_t Index>
struct GetTupleTypeIndex<T, std::tuple<>, Index> : std::integral_constant<std::size_t, static_cast<std::size_t>(-1)> {};
